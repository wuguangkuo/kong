    ...
    describe("nginx_* injected directives aliases", function()
      ...
      describe("'upstream_keepalive'", function()
        ...
        describe("1.2 Nginx template", function()
          ...
          it("'upstream_keepalive = 0' disables upstream keepalive", function()
            local conf = assert(conf_loader(helpers.test_conf_path, {
              prefix = tmp_config.prefix,
          ...
          it("'upstream_keepalive' has precedence over 'nginx_http_upstream_keepalive'", function()
            local conf = assert(conf_loader(helpers.test_conf_path, {
              prefix = tmp_config.prefix,
              nginx_http_upstream_keepalive = "NONE",
        ...
        describe("latest Nginx template", function()
          ...
          it("'upstream_keepalive = 0' always has precedence", function()
            local conf = assert(conf_loader(helpers.test_conf_path, {
              prefix = tmp_config.prefix,
              upstream_keepalive = 0,
            }))
          ...
          it("'nginx_http_upstream_keepalive' has precedence if 'upstream_keepalive != 0'", function()
            local conf = assert(conf_loader(helpers.test_conf_path, {
              prefix = tmp_config.prefix,
              nginx_http_upstream_keepalive = "NONE",
              upstream_keepalive = 60,
